...
<body>
    ...
    <?php
        ...
        $mysqli_result = mysqli_query($connection, $sqlCart);
    ?>
    ...
    <header>
        ...
        <div id="iconsWrapper">
            ...
            <div>
                <button class="sign_in_button"> Sign In
                    <div class="icon">
    ...
    <div class="order-container">
        <div class="shopping-cart">
            ...
            <div class="shopping-cart-description">
                Unlock a world of convenience and care with our online pharmacy portal. Browse our wide range of trusted medications and health products in your shopping cart, taking the first step towards a healthier you. </div>
        </div>
        <div class="item-cart">
            ...
            <table>
                ...
                <?php
                    while ($row = mysqli_fetch_array($mysqli_result)) {
                        $sql = "select * from cart where product_id=".$row['product_id'];
                        $mysqli_cartDetails = mysqli_query($conn, $sql);
                        $cartDetails = mysqli_fetch_assoc($mysqli_cartDetails);

                        $sql = "select * from product where pid=".$row['product_id'];
                ...
                ?>
                    <tr>
                        ...
                        ?>
                            <td>
                                <?php echo $cartDetails['qty'] ?>
                            </td>
                            <td>
                                <?php echo $product['product_name'] ?>
                            </td>
                            <td>
                                <?php echo $product['price'] *  $cartDetails['qty'] ?>
                            </td>
                        <?php
                            }
                        ?>
            ...
            <div class="total-row">
                <div class="total">
                    <p>Total : <span class="tot-amount">Rs 1700.00</span></p>
                </div>
                <div class="order-btn">
                    
                    <button onclick="window.location ='./payment.html'" class="cssbuttons-io-button"> Order
                        <div class="icon">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"></path><path fill="currentColor" d="M16.172 11l-5.364-5.364 1.414-1.414L20 12l-7.778 7.778-1.414-1.414L16.172 13H4v-2z"></path></svg>
                        </div>
                      </button>
