        ...
        <div id="bodyWrapper">
            ...
            <tr>
                <td>
                    ...
                    <div class="contactus">
                        <img src="assets/location.jpg" alignment="center" width="80px" height="120px"><p>Location &nbsp;&nbsp;&nbsp;&nbsp; PillBox Pharmacy PVT Ltd</p><br>
                    </div>
                    <div class="contactus">
                        <img src="assets/phone.jpg" alignment="center" width="80px" height="120px"><p>Mobile &nbsp;&nbsp;+941234567</p>&nbsp;&nbsp;&nbsp;&nbsp;<p>Hotline &nbsp;&nbsp;+941234568</p>
                    </div> 
                    <div class="contactus">
                        <img src="assets/social.jpg" alignment="center" width="80px" height="120px"><p><a href="">Facebook</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="">Instagram</a></p>                    
                    </div> 
                    </fieldset>
                </td>
                <td>
                    ...
                    <fieldset>
                        ...
                        ?>
                        <div>
                        <button onclick="showAnswer(<?php echo $row['qid'] ?>)" class="button">
